...
public class Estimate_Heuristic {
    ...
    public static void main(String[] args)throws Exception
    {
        ...
        for(int iter=1; iter<=num_cases; iter++)
        {
            ...
            double[] remaining_expected_utility= new double[n+1]; //We maintain the vector of expected utility for remaining players
            int[] number_of_neigh= new int[n+1]; //we maintain the number of players
